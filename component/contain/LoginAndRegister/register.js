                ...
                <SafeAreaView style={styles.SafeAreaView}>
                    <View style={styles.SafeAreaViewView}>
                        <View style={styles.SafeAreaViewViewView}>
                            <TextInput placeholder="NAME" onChangeText={(value)=>this.username = value} style={styles.userAndPassword}/>
                        </View>
                        <View style={styles.SafeAreaViewViewView}>
                            <TextInput placeholder="EMAIL" onChangeText={(value)=>this.username = value} style={styles.userAndPassword}/>
                        </View>
                        <View style={styles.SafeAreaViewViewView}>
